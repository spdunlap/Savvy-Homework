...
// const arrayOfStrings = data.map(user => {
...
// const user9 = todo.filter(task => task.userId === 9);
// console.log(user9);
...
let totalTask3 = todo.filter(
  task =>
    task.userId === 3 && (task.completed === false || task.completed === true)
);

let totalTask7 = todo.filter(
  task =>
    task.userId === 7 && (task.completed === false || task.completed === true)
);

let totalTask8 = todo.filter(
  task =>
    task.userId === 8 && (task.completed === false || task.completed === true)
);

// console.log("totalTasks:", totalTask3.length);

let totalIncomplete3 = todo.filter(
  task => task.userId === 3 && task.completed === false
);

let totalIncomplete7 = todo.filter(
  task => task.userId === 7 && task.completed === false
);

let totalIncomplete8 = todo.filter(
  task => task.userId === 8 && task.completed === false
);

// console.log("totalIncomplete", totalIncomplete.length);

let incompleteTask3 = todo
  .filter(task => task.userId === 3 && task.completed === false)
  .map(task => {
    let taskName = task.title;
    return `Incomplete Tasks: ${taskName}`;
  });

let incompleteTask7 = todo
  .filter(task => task.userId === 7 && task.completed === false)
  .map(task => {
    let taskName = task.title;
    return `Incomplete Tasks: ${taskName}`;
  });

let incompleteTask8 = todo
  .filter(task => task.userId === 8 && task.completed === false)
  .map(task => {
    let taskName = task.title;
    return `Incomplete Tasks: ${taskName}`;
  });
...
user3 = {
  totalTask: totalTask3.length,
  totalIncomplete: totalIncomplete3.length,
  incompleteTasks: incompleteTask3
};

user7 = {
  totalTask: totalTask7.length,
  totalIncomplete: totalIncomplete7.length,
  incompleteTasks: incompleteTask7
};

user8 = {
  totalTask: totalTask8.length,
  totalIncomplete: totalIncomplete8.length,
  incompleteTasks: incompleteTask8
};
