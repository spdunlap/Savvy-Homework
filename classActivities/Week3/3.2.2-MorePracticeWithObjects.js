...
obj["favorites"] = { movie: "", number: 0, color: "" };

obj.list = ["a", "b", 3, "d", ["e", 4, 5], { f: 6 }];

// how many lines will the following for...of statement print?
// what do you expect to see on each line? for (let key in keys) { console.log(Key is: ${key} and value is: ${obj[key]}); } // use a template literal to print a sentence about your favorite movie and color
